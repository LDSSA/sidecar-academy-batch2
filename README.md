...
1. Log into _GitHub_
1. Create a new **private** _GitHub_ repository called *sidecar-academy-workspace*, see
...
1. Clone your `<username>/sidecar-academy-workspace` repository
...
You will be cloning the [sidecar-academy-batch2](https://github.com/LDSSA/sidecar-academy-batch2)
repository.
...
1. Open a Terminal or Git Bash, the next steps are on this terminal
1. Clone the students repository
[sidecar-academy-batch2](https://github.com/LDSSA/sidecar-academy-batch2)
...
All learning units come as a set of Jupyter Notebooks.
...
Once you have the application open feel free to explore the first learning
unit structure.
...
1. Enter the Learning unit directory in your workspace directory (`sidecar-academy-workspace`).
...
changes.
It's time to commit the changes, which just means adding them to your `sidecar-academy-workspace`
...
[sidecar-academy-batch2](https://github.com/LDSSA/sidecar-academy-batch2)
repository.
A new Learning Unit is released according to the SideCar Academy's calendar!
...
1. Once a new Learning Unit is available, pull the changes from the [sidecar-academy-batch2](https://github.com/LDSSA/sidecar-academy-batch2) repo:
...
1. Copy the Learning Unit to your `sidecar-academy-workspace` repo
...
1. Change to the `sidecar-academy-workspace` dir
...
1. [When I pull from the `sidecar-academy-batch2` repository I get an error](#When-I-pull-from-the-sidecar-academy-batch2-repository-I-get-the-error)
...
_git_ is telling us that changes were made by you to the files on the `~/projects/sidecar-academy-batch2` folder, and is not pulling the changes made by the instructors because they would override the changes that you made there. To fix this do the following:
